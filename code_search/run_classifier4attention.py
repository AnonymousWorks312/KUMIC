...
from utils4attention import (compute_metrics, convert_examples_to_features,
                             output_modes, processors, convert_examples_to_features_code2comment)
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="../pretrained_codebert", type=str,
                        help="Path to pre-trained model or shortcut name")
    parser.add_argument("--task_name", default='codesearch', type=str,
                        help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    parser.add_argument("--output_dir", default=f"saved_model/{dataset}-comment2code-500-0.75", type=str,
    ...
    parser.add_argument("--train_file", default=f"{dataset}-20-spl-code-comment2code-75.train", type=str,
                        help="train file")
    parser.add_argument("--dev_file", default=f"{dataset}-0-spl-code-comment2code.train", type=str,
                        help="dev file")
    parser.add_argument("--test_file", default=f"{dataset}-20-spl-code-comment2code.train", type=str,
                        help="test file")
    parser.add_argument("--pred_model_dir", default=f"saved_model/{dataset}-20-comment2code-500/checkpoint-best", type=str,
                        help='model for prediction')
    parser.add_argument("--test_result_dir", default='./test_results-1.0.txt', type=str,
                        help='path to store test result')
    # parser.add_argument("--cuda_id", default="0", nargs='+', type=str)
